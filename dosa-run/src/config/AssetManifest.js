...
export const ASSETS = [
  ...
  },
  {
    key: 'bg-limestone',
    type: 'image',
    path: 'backgrounds/limestone-buildings.png',
    real: false,
    placeholder: { kind: 'limestone', width: 480, height: 210 },
  },
  {
    key: 'bg-storefronts',
    type: 'image',
    path: 'backgrounds/storefronts.png',
    real: false,
    placeholder: { kind: 'storefronts', width: 480, height: 150 },
  },
  {
    key: 'bg-sidewalk',
    type: 'image',
    path: 'backgrounds/sidewalk.png',
    real: false,
    placeholder: { kind: 'sidewalk', width: 480, height: 58 },
  },
  {
    key: 'bg-road',
    type: 'image',
